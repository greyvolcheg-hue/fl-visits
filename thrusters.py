...
"""Read and set thruster speed in a running Freelancer, without a restart.
    ...
    thrusters.py                    # what every thruster is set to
    thrusters.py 263739 500         # set one, by its ids_name
    thrusters.py all 350            # set all six
...
from speed import NotRunning, find_pid, regions  # noqa: E402
